...
public class AndarGalo : MonoBehaviour
{
 //  [SerializeField] GameManager _gameManager;

    [SerializeField] float _velociGalo;
    [SerializeField] Transform _direcaoGalo;
    ...
    void Voltar(Transform value) {
        ...
        transform.position = Vector2.MoveTowards(transform.position, value.position, _velociGalo * Time.deltaTime);
